/**
 * Entry de línea de comandos de el registro del catálogo de obras sociales.
 *
 * POR QUÉ ESTO ES UN ARCHIVO APARTE
 *
 * Antes el arranque vivía al final de `registrar-obras-sociales.mjs` detrás de la guarda clásica:
 *
 ...
 *
 *     node tools/registrar-obras-sociales.cli.mjs
 */
import { main } from "./registrar-obras-sociales.mjs";
