    ...
    <header className="sticky top-0 z-40 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border-b border-slate-200 dark:border-slate-800 py-3">
      <div className="flex items-center justify-between p-4 pb-2">
        {/*         <div className="flex size-12 shrink-0 items-center">
          <div
            className="aspect-square size-10 rounded bg-cover bg-center bg-no-repeat"
            style={{
        ...
        {currentRole && (
          <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded ${currentRole.bgColor} ${currentRole.textColor} text-sm font-semibold shadow-sm`}>
