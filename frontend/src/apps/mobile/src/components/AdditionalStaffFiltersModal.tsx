  ...
  return (
    <div className="fixed inset-0 overflow-y-auto" style={{ zIndex: 100 }}>
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        {/* Panel */}
        <div
          className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-2xl max-h-[95vh] overflow-y-auto"
              ...
              <div className="overflow-y-auto flex-1 py-6 space-y-8">
                    ...
                    {(["active", "inactive", "all"] as const).map((value) => {
                      ...
                      return (
                        <div key={value} className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-700">
                          ...
                          <div
                            className={`relative w-11 h-6 rounded-full transition-colors cursor-pointer ${statusFilter === value ? "bg-blue-600" : "bg-gray-200 dark:bg-slate-700"}`}
                ...
                <section className="space-y-4 pb-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-700">
                    ...
                    <div
                      className={`relative w-11 h-6 rounded-full transition-colors cursor-pointer ${contractActive ? "bg-blue-600" : "bg-gray-200 dark:bg-slate-700"}`}
