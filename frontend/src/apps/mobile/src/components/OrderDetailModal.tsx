...
export default function OrderDetailModal({ order, isOpen, onClose }: OrderDetailModalProps) {
  ...
  return (
    <>
      ...
      <div
        ref={modalRef}
        className={`fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[95vw] max-w-5xl max-h-[90vh] bg-[#2c3e50] rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-300 ${
      ...
      >
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between px-8 py-6 border-b border-slate-600/50">
            ...
            <button
              onClick={onClose}
              className="flex h-10 w-10 items-center justify-center rounded-lg text-slate-300 hover:text-white hover:bg-slate-700/50 transition-colors"
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <img
                          ...
                          alt="Order"
                          className="w-full max-w-sm h-auto rounded-lg border-2 border-slate-600/50 mt-2 shadow-lg"
                        />
                      </div>
                    </div>
                  )}
