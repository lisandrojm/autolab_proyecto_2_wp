        ...
        <div className="bg-white dark:bg-slate-900/70 rounded-xl p-4 shadow-sm mb-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              {loading ? (
                <div className="h-9 w-16 bg-slate-200 dark:bg-slate-700 rounded animate-pulse mt-1" />
              ) : (
                <p className="text-3xl font-bold text-primary">{availableDays?.available || 0}</p>
              )}
            </div>
