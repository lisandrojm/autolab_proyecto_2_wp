...
import { faBriefcase, faBuilding, faIdCard, faClock, faLayerGroup, faChevronDown, faUserShield, faUsers } from '@fortawesome/free-solid-svg-icons';
...
/**
 * ASIGNACIÓN: DÓNDE TRABAJA LA PERSONA.
 *
 * Proyecto, sede, contrato, horario y las áreas y turnos —los suyos y los que coordina—. Era el final
 * del Perfil y lo alargaba de más; como pestaña propia de la barra de abajo, el Perfil queda con los
 * datos de la persona y esto con los de su trabajo. De paso el Perfil ya no espera a que carguen
 * proyectos, áreas y turnos, que sólo se usan acá.
 */
export default function Asignacion() {
  ...
  const encabezado = (
    <SectionHeader
      icon={faBriefcase}
      titulo="Asignación"
      info={"Dónde trabajás: proyecto, sede, contrato, vigencia y horario, y las áreas y turnos que tenés asignados.\n\nSi coordinás áreas y turnos, también aparecen acá. Si estás en más de un proyecto, elegí cuál ver."}
    />
  );
    ...
    return (
      <div className="flex-1 pb-24">
        ...
        <div className="px-4 pt-4">
          <div className="h-64 animate-pulse rounded-2xl border border-slate-100 bg-white dark:border-slate-800 dark:bg-slate-900/70" />
        </div>
      </div>
    );
