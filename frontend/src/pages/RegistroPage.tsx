        ...
        <div className="px-6 py-4 flex items-center gap-3">
          {activeTab !== tabs[0].key && (
            <button
              ...
              onClick={handleBack}
              disabled={submitting}
              className="shrink-0 px-6 py-4 rounded-lg text-center font-medium tracking-wide uppercase border border-gray-600 text-gray-300 hover:bg-gray-800 disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
            >
              Anterior
            </button>
          )}
          <button
            ...
            className="flex-1 py-4 rounded-lg text-center text-white font-medium tracking-wide uppercase bg-blue-600 hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
          >
