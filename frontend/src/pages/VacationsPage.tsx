          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-6 pt-2 w-full border-t border-gray-100 dark:border-gray-700/50">
                ...
                <div className="flex flex-col">
                  <span className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1 flex gap-1 items-center">
                    <FontAwesomeIcon icon={faIdCard} className="h-3 w-3 text-gray-400" /> Rol/es Empresa
                  </span>
                  {(() => {
            ...
            <div className="flex flex-col gap-4">
              ...
              {selectedVacation.pdfPreAprobacionUrl
                ? (() => {
                    ...
                    const effectiveEmpresas = empresaInfo?.hasContractEmpresa && empresaInfo.contractEmpresa ? [empresaInfo.contractEmpresa] : (empresaInfo?.projectEmpresas ?? []);
