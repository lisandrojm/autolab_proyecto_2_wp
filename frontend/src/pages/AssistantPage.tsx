...
const HELP_KEY = "assistant" as const;
...
export const AssistantPage: React.FC = () => {
  ...
  return (
    <PageLayout
      title="Asistente IA"
      subtitle="Tu asistente personal para marketing y creatividad"
      icon={Bot}
      infoModal={{
        isOpen: openInfo,
    ...
    >
      <div className="flex flex-col h-[80vh]">
        ...
        <div className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 px-4 py-4 mt-auto sticky bottom-0">
