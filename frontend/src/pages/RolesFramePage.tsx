...
export const RolesFramePage: React.FC = () => {
  ...
  const getCategoryNumbersStr = (role: RoleFrameItem) => {
    return role.data?.categoriasSat
  ...
  const handleDelete = async (role: RoleFrameItem) => {
    const result = await sweetAlert.confirm(
      "¿Eliminar función?",
      `¿Estás seguro de que quieres eliminar la función "${role.name}"?`
    );
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-600 dark:text-gray-400">
                          {getCategoryNumbersStr(role) ? `Categorías: ${getCategoryNumbersStr(role)}` : "Ninguna"}
                        </span>
                      </div>
                    </td>
          ...
          <form id="role-frame-form" onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="input-field w-full px-3 py-2 border rounded bg-white dark:bg-gray-950 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100"
                placeholder="Ej: Motion Graphic"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative mb-2">
                <input
                  ...
                  className="input-field w-full pl-9 pr-8 py-2 border rounded bg-white dark:bg-gray-950 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100"
                  placeholder="Buscar categorías por nombre o número..."
                />
