                      ...
                      <div className="flex items-center gap-3 overflow-hidden">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="flex gap-1 mt-1">
                            ...
                            {user.positionId && <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] bg-purple-50 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300">{typeof user.positionId === "object" ? user.positionId.name : "Cargo"}</span>}
                          </div>
                        </div>
                      </div>
                    ...
                    <div key={user._id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/20 rounded-lg border border-gray-100 dark:border-gray-700 hover:border-red-200 dark:hover:border-red-900/30 transition-colors group">
                      <div className="flex items-center gap-3 overflow-hidden">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="flex gap-1 mt-1">{user.areaId && <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300">{typeof user.areaId === "object" ? user.areaId.name : "Area"}</span>}</div>
                        </div>
                      </div>
