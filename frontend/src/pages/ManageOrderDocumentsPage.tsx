...
import { hrManagementAPI, OrderDocument } from "../api/management";
    ...
    <PageLayout title="Documentos RRHH" subtitle="Gestión de documentos del personal">
      <div>
        <div className="mb-6 relative">
          ...
          <input type="text" placeholder="Buscar documentos..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" />
        </div>
