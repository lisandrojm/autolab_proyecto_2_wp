...
export const RequestsListPage: React.FC = () => {
  ...
  return (
    <PageLayout
      title="Pedidos de Ausencias"
      subtitle="Gestión de solicitudes de ausencias"
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-2">
              <select
                ...
                className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-white dark:bg-gray-900 text-gray-900 dark:text-white"
              >
