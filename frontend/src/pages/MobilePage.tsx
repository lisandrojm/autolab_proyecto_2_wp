...
import { faMobileScreen, faUserTie, faUsers, faExclamationTriangle, faArrowLeft } from "@fortawesome/free-solid-svg-icons";
...
export const MobilePage: React.FC = () => {
  ...
  // Si no tiene acceso mobile, mostrar mensaje de error
  if (!hasMobileAccess) {
    return (
  ...
  // Fallback: tiene mobile:access pero no es ni colaborador ni coordinador
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 text-center">
        <div className="mb-6">
