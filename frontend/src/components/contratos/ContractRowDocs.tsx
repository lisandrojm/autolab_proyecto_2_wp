...
import { faFilePdf, faUpload, faSpinner, faLock } from "@fortawesome/free-solid-svg-icons";
...
/** Las tres cabeceras de las columnas de documentos (mismo estilo que el resto de la tabla). */
...
}> = ({ record, contratoFrames, allEstados, activeReleases, onDownloadContract, onDownloadRelease, onUploadAlta, canUploadAlta = true }) => {
