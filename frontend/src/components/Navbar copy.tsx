...
export const MobileNavbar: React.FC = () => {
  ...
  const menuItems = useMemo(() => {
    ...
    if (isSuperAdminTenant) {
      ...
      if (hasPermission("roles:view")) base.push({ path: "/roles", icon: faShield, label: "Roles", scope: "global", count: adminCounts.roles, badge: "Finish", badgeColor: "bg-blue-501" });
      ...
      if (hasPermission("vacationRequests:view")) base.push({ path: "/hr/vacations", icon: faUmbrellaBeach, label: "Vacaciones", scope: "global", badge: "Next", badgeColor: "bg-orange-400" });
