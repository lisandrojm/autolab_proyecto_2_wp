    ...
    <div className="space-y-6">
      ...
      <div className="w-auto flex justify-center m-0 p-0 items-center">
        <div className="flex gap-3 w-96">
          <button onClick={() => setSelectedDevice("ios")} className={`flex-1 px-4 py-3 rounded border-2 transition-all flex items-center justify-center gap-2 ${selectedDevice === "ios" ? "border-blue-500 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300" : "border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:border-gray-300 dark:hover:border-gray-600"}`}>
            <FontAwesomeIcon icon={faApple} className="h-5 w-5" />
            <span className="font-medium">iOS</span>
          </button>
          <button onClick={() => setSelectedDevice("android")} className={`flex-1 px-4 py-3 rounded border-2 transition-all flex items-center justify-center gap-2 ${selectedDevice === "android" ? "border-blue-500 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300" : "border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:border-gray-300 dark:hover:border-gray-600"}`}>
      ...
      <div className="bg-gray-100 dark:bg-gray-900 rounded p-6 flex justify-center items-center min-h-[400px]">
        <div className="relative">
            ...
            <div className="bg-gradient-to-b from-gray-800 to-gray-900 p-4 pt-12">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-4 mb-4">
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-10 h-10 bg-primary-500 rounded flex items-center justify-center">
          ...
          {config.badge && config.badge > 0 && selectedDevice === "ios" && <div className="absolute -top-2 -right-2 w-8 h-8 bg-red-500 rounded flex items-center justify-center text-white text-xs font-bold shadow-lg">{config.badge}</div>}
        </div>
      </div>
