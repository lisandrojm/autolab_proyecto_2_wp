  ...
  return (
    <>
      <div
        ...
        onClick={onClose}
      />
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-gray-800 rounded-lg shadow-xl z-50 w-full max-w-md p-6">
          ...
          <label className="flex items-center justify-between cursor-pointer p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
            <div className="flex flex-col">
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                Incluir mis imágenes personales
              </span>
              <span className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                Por defecto solo se muestran las imágenes del cliente
              </span>
            </div>
            <div className="relative ml-4">
              <input
                type="checkbox"
                checked={pendingIncludeUserAssets}
                onChange={(e) => onTogglePendingUserAssets(e.target.checked)}
