...
export const TeamDropboxTab: React.FC<TeamDropboxTabProps> = ({ project }) => {
  ...
  const projectHint = project?.name ? String(project.name) : "";
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        <input
          ...
          placeholder={`Filtrar por nombre${projectHint ? ` (ej: ${projectHint}, contrato, apellido)` : " (ej: 426_LN, contrato, apellido)"}`}
          value={search}
