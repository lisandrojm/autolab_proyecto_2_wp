...
router.put("/settings", async (req: AuthenticatedRequest & TenantRequest, res) => {
  try {
    ...
    */
    ...
    if (memosoftHorasExtra !== undefined) cambios.memosoftHorasExtra = memosoftHorasExtra;
    if (memosoftJornalBase !== undefined) cambios.memosoftJornalBase = memosoftJornalBase;
...
router.put("/:id", async (req: AuthenticatedRequest & TenantRequest, res) => {
  try {
    ...
    if (statusVal !== undefined) {
      if (typeof statusVal === "string") updateData.isActive = statusVal === "Activa";
      else updateData.isActive = !!statusVal;
    }
