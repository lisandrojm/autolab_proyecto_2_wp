  ...
  try {
    ...
    */
    ...
    try {
      ...
      const r = await clonarEnMongo(baseDatos, nombresDeColecciones(archivos), (tenant as any)?.integrations?.backup?.ultimoSlotOk, (tenant as any)?.integrations?.backup?.ultimaBaseCopia);
      mongo.ok = true;
