...
import { efectosVigentesEn, validarEfecto, reemplazarVigentes, ConceptoConocido } from "./efectos.js";
...
const LICENCIA: ConceptoConocido = { codigo: "0012", descripcion: "Licencia por Enfermedad", usaPar1: true, usaPar2: false, unidadPar1: "cantidad", unidadPar2: null };
/** 0000 Jornal: usa par2, cantidad. Es el que cobra el reemplazante jornalero. */
const JORNAL: ConceptoConocido = { codigo: "0000", descripcion: "Jornal", usaPar1: false, usaPar2: true, unidadPar1: null, unidadPar2: "cantidad" };
...
describe("liquidación · qué efectos rigen ese día", () => {
  ...
  it("un efecto de una empresa no se aplica en otra", () => {
    const vigentes = efectosVigentesEn([efecto({ empresaId: "emp2030" as any })], "2026-08-15", { empresaId: "empFzero" });
  ...
  it("un efecto de una empresa tampoco se aplica cuando no se sabe de qué empresa es el contrato", () => {
    ...
    const vigentes = efectosVigentesEn([efecto({ empresaId: "emp2030" as any })], "2026-08-15", { empresaId: null });
  ...
  it("los efectos son aditivos: si matchean dos, salen los dos", () => {
    ...
    const lista = [efecto({ conceptoCodigo: "0012" }), efecto({ conceptoCodigo: "0017", empresaId: "emp2030" as any })];
