...
describe("el default rinde el nombre de siempre", () => {
  ...
  it("arranca con el proyecto y termina con la empleadora", () => {
    ...
    assert.equal(
      nombre,
      "426-LN+_gonzalez-rotstein_Contrato_Jornada-2030-SRL_Alta-20260810_Baja--_CUIL-20331501027_juanmanuel.gonzalezrotstein-ARROBA-gmail.com_Empresa-30710295839",
    );
