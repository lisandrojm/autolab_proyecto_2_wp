...
function wrapHtml(bodyHtml: string, membrete?: MembreteInput): string {
 ...
 */
export async function buildDocPdf(content: string, data: Record<string, any>, membrete?: MembreteInput): Promise<Buffer> {
