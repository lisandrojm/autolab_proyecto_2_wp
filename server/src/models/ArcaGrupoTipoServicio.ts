...
const schema = new Schema<IArcaGrupoTipoServicio>(
  {
...
export const ArcaGrupoTipoServicio: Model<IArcaGrupoTipoServicio> = mongoose.model<IArcaGrupoTipoServicio>("ArcaGrupoTipoServicio", schema);
