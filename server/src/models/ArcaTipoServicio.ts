...
const schema = new Schema<IArcaTipoServicio>(
  {
...
export const ArcaTipoServicio: Model<IArcaTipoServicio> = mongoose.model<IArcaTipoServicio>("ArcaTipoServicio", schema);
