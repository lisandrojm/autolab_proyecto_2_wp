 ...
 */
export const ESTRELLAS_VALIDAS = [1, 2, 4, 5] as const;
export const ORIGENES_CALIFICACION = ["fin_contrato", "equipos", "usuarios", "solicitud_renovacion"] as const;
...
const calificacionSchema = new Schema<ICalificacion>(
  {
    ...
    estrellas: { type: Number, enum: ESTRELLAS_VALIDAS as unknown as number[], required: true },
    comentario: { type: String, trim: true, maxlength: 1000 },
    origen: { type: String, enum: ORIGENES_CALIFICACION as unknown as string[], required: true },
