...
const tramoSchema = new Schema<ITramoAntiguedad>(
  {
...
const leaveAccountSchema = new Schema<ILeaveAccount>(
  {
...
export const LeaveAccount: Model<ILeaveAccount> = model<ILeaveAccount>("LeaveAccount", leaveAccountSchema);
