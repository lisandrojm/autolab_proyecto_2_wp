...
const ProjectPdfConfigSchema = new Schema<IProjectPdfConfig>(
  {
    tenantId: {
...
export const ProjectPdfConfig = mongoose.model<IProjectPdfConfig>("ProjectPdfConfig", ProjectPdfConfigSchema);
