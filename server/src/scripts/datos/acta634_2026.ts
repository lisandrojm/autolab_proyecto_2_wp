...
export const TRAMOS = [
  { codigo: "2026-04", desde: "2026-04-01", porcentaje: 9.5, base: "marzo 2026", baseDesde: "2026-03-01", acumulativo: true, regimen: "general" as const, nota: "Primer tramo del 2.º tramo paritario." },
  { codigo: "2026-06", desde: "2026-06-01", porcentaje: 4.8, base: "mayo 2026", baseDesde: "2026-05-01", acumulativo: true, regimen: "general" as const, nota: "Acumulativo sobre el anterior: 1,095 × 1,048 = 14,756 %." },
  { codigo: "2026-04-alt", desde: "2026-04-01", porcentaje: 7, base: "marzo 2026", baseDesde: "2026-03-01", acumulativo: false, regimen: "alternativo" as const, nota: "Art. 3.2: pequeñas productoras que así lo convengan y canales del interior." },
  { codigo: "2026-05-alt", desde: "2026-05-01", porcentaje: 9.5, base: "marzo 2026", baseDesde: "2026-03-01", acumulativo: false, regimen: "alternativo" as const, absorbe: "2026-04-alt", nota: "Se calcula sobre marzo y absorbe el 7 % de abril." },
  { codigo: "2026-06-alt", desde: "2026-06-01", porcentaje: 4.8, base: "mayo 2026", baseDesde: "2026-05-01", acumulativo: true, regimen: "alternativo" as const, nota: "Igual que el general." },
];
 ...
 */
export const ADICIONALES: AdicionalDelActa[] = [
