...
router.get("/", requireTenant, authenticateToken, requirePermission("config_holidays:view"), async (req, res) => {
    try {
...
router.post("/", requireTenant, authenticateToken, requirePermission("config_holidays:view"), async (req, res) => {
    try {
...
router.put("/:id", requireTenant, authenticateToken, requirePermission("config_holidays:view"), async (req, res) => {
    try {
...
router.delete("/:id", requireTenant, authenticateToken, requirePermission("config_holidays:view"), async (req, res) => {
    try {
        const holidayId = toObjectIdOrNull(req.params.id);
        const tenantId = toObjectIdOrNull(req.tenantObjectId);
        if (!holidayId || !tenantId) {
...
router.get("/template", requireTenant, authenticateToken, requirePermission("config_holidays:view"), async (req, res) => {
    try {
        const wsData = [
...
router.post("/import", requireTenant, authenticateToken, requirePermission("config_holidays:view"), upload.single("file"), async (req, res) => {
    try {
        if (!req.file) {
