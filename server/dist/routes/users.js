...
router.get("/contracts-overview", requireTenant, authenticateToken, requirePermission("admin_contracts:view"), async (req, res) => {
    try {
        ...
        for (const m of memberships) {
            ...
            if (empresaContratoId && String(contratoActivo.empresaContratoId ?? "") !== empresaContratoId)
                continue;
...
router.patch("/:id", requireTenant, authenticateToken, permisoSobreSolicitudPropia(), async (req, res) => {
    try {
