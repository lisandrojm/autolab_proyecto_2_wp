...
export const redondearCentavos = (n) => Math.round(n * 100 + Number.EPSILON) / 100;
/**
 ...
 */
export function calcularEscalaGrupo(entrada) {
 ...
 */
export function compararConActa(calculada, acta, tolerancia = TOLERANCIA_CENTAVO) {
    const pares = [
 ...
 */
export function deducirAdicionalPct(basico, adicionalMonto) {
