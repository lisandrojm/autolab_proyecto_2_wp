...
export declare function getOrderRemainingCost(o: any, category: any): number;
export declare function recalculateUserOrderBalance(tenantId: any, userId: any, orderConfigId: any, year: number, subtypeId?: string): Promise<void>;
