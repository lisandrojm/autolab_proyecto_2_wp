...
const contexto = (texto, i, largo) => texto
 ...
 */
export const analizarPlantilla = (contenido) => {
    ...
    for (const m of texto.matchAll(/\{+|\}+/g))
        corridas.push({ i: m.index ?? 0, llaves: m[0] });
    let k = 0;
...
export const plantillaSana = (contenido) => analizarPlantilla(contenido).problemas.length === 0;
