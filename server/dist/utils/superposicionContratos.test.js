...
import { horariosSePisan, superposiciones, choquesDelEquipo } from "./superposicionContratos.js";
...
const puestoEq = (id, x = {}) => ({ puestoId: id, etiqueta: `puesto ${id}`, userId: "u1", dias: [1, 2, 3, 4, 5], inTime: "08:00", outTime: "14:00", shiftId: null, ...x });
