...
export function vencidasPorConvenio(vencidas) {
    const porConv = new Map();
    for (const v of vencidas)
        porConv.set(v.convenio, [...(porConv.get(v.convenio) || []), v]);
