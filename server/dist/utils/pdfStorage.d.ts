 ...
 */
export declare function savePdfToStorage(tenantId: string, userId: string, orderNumber: string, pdfBuffer: Buffer, identidadTag?: string, 
/** Datos extra para el patrón de nomenclatura (proyecto, persona, empleadora). */
datosNombre?: Record<string, string>): Promise<string>;
/** `identidadTag`: ver `savePdfToStorage`. */
export declare function savePdfVacationToStorage(tenantId: string, userId: string, vacationNumber: string, pdfBuffer: Buffer, identidadTag?: string, 
/** Datos extra para el patrón de nomenclatura (proyecto, persona, empleadora). */
datosNombre?: Record<string, string>): Promise<string>;
