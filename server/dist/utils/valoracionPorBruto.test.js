...
import { valorarPorBruto } from "./valoracionPorBruto.js";
...
const cat = (id, bruto, convenio = "0634/11") => ({ id, convenio, bruto, nombre: id });
const nivelDe = (r, id) => r.get(id)?.valoracionId ?? null;
