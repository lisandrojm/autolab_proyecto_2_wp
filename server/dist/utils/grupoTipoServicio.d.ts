...
export declare const PRIMER_CODIGO_DISCONTINUO = 500;
export declare const GRUPO_CONTINUOS = "1";
export declare const GRUPO_DISCONTINUOS = "2";
 ...
 */
export declare function grupoDeTipoServicio(codigo: unknown): GrupoTipoServicio | "";
/** ¿Ese tipo de servicio pertenece a ese grupo? Sin código o sin grupo, no hay nada que contradecir. */
export declare function tipoPerteneceAlGrupo(codigoTipo: unknown, grupo: unknown): boolean;
