...
import { isEmpty, buildAdditiveSet, buildContractKey, findNewContracts, USER_FRAME_WHITELIST, USERPROJECT_FRAME_WHITELIST, } from "./additiveSync.js";
// =========================================================================
// (a) isEmpty
// =========================================================================
describe("isEmpty", () => {
...
describe("Whitelists", () => {
    it("USER_FRAME_WHITELIST does NOT contain protected fields", () => {
        ...
        for (const field of protectedFields) {
            assert.equal(USER_FRAME_WHITELIST.includes(field), false, `USER_FRAME_WHITELIST should NOT include '${field}'`);
        }
    });
