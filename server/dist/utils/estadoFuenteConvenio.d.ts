...
export declare const ESTADOS_DECLARABLES: readonly ["sin_revisar", "sin_fuente_conocida", "no_aplica"];
export type EstadoDeclarado = (typeof ESTADOS_DECLARABLES)[number];
export declare const esDeclarable: (v: unknown) => v is EstadoDeclarado;
/**
 ...
 */
export declare const estadoFuenteDe: (tieneFuenteAsignada: boolean, declarado?: string | null) => EstadoFuenteConvenio;
/**
 ...
 */
export declare const ETIQUETA_ESTADO_FUENTE: Record<EstadoFuenteConvenio, string>;
