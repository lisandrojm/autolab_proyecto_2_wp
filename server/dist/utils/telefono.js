...
export const digitosNacionales = (texto) => {
...
export const celularValido = (texto) => /^[\d\s()+-]+$/.test(String(texto || "")) && new RegExp(`^[1-9]\\d{${CELULAR_DIGITOS - 1}}$`).test(digitosNacionales(texto));
