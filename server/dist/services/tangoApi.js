...
export class TangoApi {
    api;
    token = process.env.TANGO_API_TOKEN || null;
    constructor() {
     ...
     */
    async getRegistro(proceso, id, empresaTangoId) {
