...
export function nombreDeBaseCopia(baseOrigen, carpeta) {
 ...
 */
export async function clonarEnMongo(baseOrigen, carpeta, colecciones, baseAnterior) {
    ...
    try {
        ...
        */
        ...
        if (baseAnterior && baseAnterior !== base)
        ...
        try {
            ...
            for (const d of databases) {
                ...
                if (n.startsWith(`${prefijo}_`) && n !== base && n !== baseOrigen)
                    aBorrar.add(n);
            }
        }
        catch {
