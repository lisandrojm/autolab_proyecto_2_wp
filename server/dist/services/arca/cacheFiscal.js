...
const clave = (tenantId, cuit) => `${tenantId}:${cuit}`;
export function leerCacheFiscal(tenantId, cuit) {
...
export function guardarCacheFiscal(tenantId, cuit, condicion) {
...
export function olvidarCacheFiscal(tenantId, cuit) {
    cache.delete(clave(tenantId, cuit));
}
