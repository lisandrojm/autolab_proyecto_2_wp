import { Schema, model, type Document, Types, Model } from "mongoose";
...
userSchema.methods.matchPassword = async function (this: IUser, candidatePassword: string): Promise<boolean> {
